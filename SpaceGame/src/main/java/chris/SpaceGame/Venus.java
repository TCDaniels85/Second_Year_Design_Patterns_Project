 ...
 * class for to represent the game object, planet Venus, provides concrete realisation of abstract Planet class methods,
...
public class Venus extends Planet {
	...
	public Venus(double x, double y, GraphicsContext gc) {
		super(x, y, gc);
		image = new Image(Venus.class.getResource("venus.png").toExternalForm());
		super.update();
		planetName = "venus";
	}
